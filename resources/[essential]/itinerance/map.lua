local blips = {
  {name="Pole Emploi", colour=66, scale=1.1, id=280, x = -271.4719543457, y = -704.67755126953, z = 37.27693939209},
   -- Airport and Airfield
   {name="Aéroport", colour=15, scale=0.9, id=307, x=-1032.690, y=-2728.141, z=13.757},
   ...
   {name="Coiffeur", colour=9, scale=0.9, id=71, x = 1933.6905517578, y = 3730.6245117188, z = 32.854434967041},
   {name="Coiffeur", colour=9, scale=0.9, id=71, x = 1211.2866210938, y = -474.07333374023, z = 66.218040466309},
   {name="Dépanneur", colour=64, scale=0.9, id=446, x = 491.0, y= -1330.0, z= 29.420988082886},
   {name="Taxi", colour=5, scale=0.9, id=198, x = 910.0, y=-170.0, z=74.700347900391},
   ...
   --{name="Condo", id=162, x=-774.559 y=331.981, z=160.002},
   --{name="Condo", id=162, x=-770.357 y=318.459, z=85.6627},
   -- Stores
  ...
  --  {name="Ammunition", colour=9, scale=0.9, id=110, x=-3157.450, y=1079.633, z=20.692},
   ...
   {name="Lifeinvader", colour=1, scale=0.9, id=77, x=-1047.900, y=-233.000, z=39.000},
   --{name="Cluckin Bell", id=357, x=-72.68752, y=6253.72656, z=31.08991},
   {name="Tequil-La La", scale=0.7, id=93, x=-565.171, y=276.625, z=83.286},
   {name="Bahama Mamas", scale=0.7, id=93, x=-1391.3672, y=-582.4521, z=0.0000},
   ...
   {name="Unicorn", scale=0.7, id=121, x=134.476, y=-1307.887, z=28.983},
   ...
   {name="Station Service", colour=1, scale=0.7, id=361, x=2581.321, y=362.039, 108.468},
    -- Police Stations
   {name="Commisariat", colour=3, scale=0.9, id=60, x=425.130, y=-979.558, z=30.711},
   ...
   {name="Hôpital", colour=3, scale=0.9, id=61, x= 295.83, y= -1446.94, z= 29.97},
...
Citizen.CreateThread(function()
  ...
  RemoveIpl("cs2_29_interior_v_lab_milo_")
  RemoveIpl("cs4_06_interior_v_methlab_milo_")
  RequestIpl("hei_cs2_29_interior_v_lab_milo_")
  RequestIpl("hei_cs4_06_interior_v_methlab_milo_")
  RemoveIpl("gr_case10_bunkerclosed")
  RemoveIpl("gr_case9_bunkerclosed")
  RemoveIpl("gr_case3_bunkerclosed")
  RemoveIpl("gr_case0_bunkerclosed")
  RemoveIpl("gr_case1_bunkerclosed")
  RemoveIpl("gr_case2_bunkerclosed")
  RemoveIpl("gr_case5_bunkerclosed")
  RemoveIpl("gr_case7_bunkerclosed")
  RemoveIpl("gr_case11_bunkerclosed")
  RemoveIpl("gr_case6_bunkerclosed")
  RemoveIpl("gr_case4_bunkerclosed")
  RequestIpl("bkr_biker_interior_placement_interior_3_biker_dlc_int_ware02_milo")
  RequestIpl("biker_dlc_int_ware02")
  RequestIpl("bkr_Biker_dlc_int_ware02")
end)
