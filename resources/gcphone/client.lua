...
function sendMessage(num, message)
  TriggerServerEvent('gcPhone:sendMessage', tostring(num), message)
end
...
RegisterNUICallback('deleteOldMessages', function ()
    TriggerServerEvent('gcPhone:deleteOldMessages')
end)
