...
export default {
  ...
  data () {
    return {
      ...
      deleteMessage: {backgroundColor: '#c03a59', display: 'Suppr. vieux messages', letter: 'X', id: -2},
  ...
  computed: {
    messagesData: function () {
      ...
      return [this.nouveauMessage, this.deleteMessage, ...mess]
    }
  },
  created: function () {
    // this.updateList()
