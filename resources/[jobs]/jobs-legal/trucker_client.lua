...
function init()
    local BLIP1 = AddBlipForCoord(TruckingCompany[0]["x"], TruckingCompany[0]["y"], TruckingCompany[0]["z"])
    SetBlipSprite(BLIP1, 436)
    SetBlipColour(BLIP1, 1)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentString(TruckingCompany[0]["name"])
  ...
  local BLIP2 = AddBlipForCoord(TruckingCompany[1]["x"], TruckingCompany[1]["y"], TruckingCompany[1]["z"])
    ...
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentString(TruckingCompany[1]["name"])
  ...
  local BLIP3 = AddBlipForCoord(TruckingCompany[2]["x"], TruckingCompany[2]["y"], TruckingCompany[2]["z"])
    ...
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentString(TruckingCompany[2]["name"])
  ...
  local BLIP4 = AddBlipForCoord(TruckingCompany[3]["x"], TruckingCompany[3]["y"], TruckingCompany[3]["z"])
    ...
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentString(TruckingCompany[3]["name"])
    ...
    if( IsEntityAttached(MISSION.trailer) and text1 == false) then
      if myjob == 6 then
        if GetEntityModel(GetPlayerPed(-1)) == 1885233650 then -- Male
          ...
          SetPedComponentVariation(GetPlayerPed(-1), 11, 61, 3, 0)
        else
          SetPedComponentVariation(GetPlayerPed(-1), 4, 35, 0, 0)
SetPedComponentVariation(GetPlayerPed(-1), 6, 25, 0, 0)
SetPedComponentVariation(GetPlayerPed(-1), 8, 2, 0, 0)
SetPedComponentVariation(GetPlayerPed(-1), 3, 23, 0, 0)
SetPedComponentVariation(GetPlayerPed(-1), 11, 3, 2, 0)
SetPedComponentVariation(GetPlayerPed(-1), 7, 0, 0, 0)
      ...
      elseif myjob == 7 then
        if GetEntityModel(GetPlayerPed(-1)) == 1885233650 then -- Male
          ...
          SetPedComponentVariation(GetPlayerPed(-1), 8, 15, 0, 0)
          SetPedComponentVariation(GetPlayerPed(-1), 3, 5, 0, 0)
          SetPedComponentVariation(GetPlayerPed(-1), 11, 17, 2, 0)
        else
          SetPedComponentVariation(GetPlayerPed(-1), 4, 35, 0, 0)
SetPedComponentVariation(GetPlayerPed(-1), 6, 25, 0, 0)
SetPedComponentVariation(GetPlayerPed(-1), 8, 2, 0, 0)
...
SetPedComponentVariation(GetPlayerPed(-1), 7, 0, 0, 0)
      ...
      elseif myjob == 8 then
        if GetEntityModel(GetPlayerPed(-1)) == 1885233650 then -- Male
          ...
          SetPedComponentVariation(GetPlayerPed(-1), 8, 15, 0, 0)
          SetPedComponentVariation(GetPlayerPed(-1), 3, 5, 0, 0)
          SetPedComponentVariation(GetPlayerPed(-1), 11, 61, 1, 0)
        else
          SetPedComponentVariation(GetPlayerPed(-1), 4, 35, 0, 0)
SetPedComponentVariation(GetPlayerPed(-1), 6, 25, 0, 0)
SetPedComponentVariation(GetPlayerPed(-1), 8, 2, 0, 0)
...
SetPedComponentVariation(GetPlayerPed(-1), 7, 0, 0, 0)
      ...
      elseif myjob == 9 then
        if GetEntityModel(GetPlayerPed(-1)) == 1885233650 then -- Male
         ...
         SetPedComponentVariation(GetPlayerPed(-1), 8, 15, 0, 0)
         SetPedComponentVariation(GetPlayerPed(-1), 3, 5, 0, 0)
         SetPedComponentVariation(GetPlayerPed(-1), 11, 61, 2, 0)
        else
         SetPedComponentVariation(GetPlayerPed(-1), 4, 35, 0, 0)
SetPedComponentVariation(GetPlayerPed(-1), 6, 25, 0, 0)
SetPedComponentVariation(GetPlayerPed(-1), 8, 2, 0, 0)
...
SetPedComponentVariation(GetPlayerPed(-1), 7, 0, 0, 0)
      ...
      TriggerEvent("mt:missiontext", "Conduisez jusqu'à la ~y~destination~w~ sur votre carte.", 10000)
      SetBlipSprite(BLIP.company, 2) --invisible
      text1 = true
    elseif( not IsEntityAttached(MISSION.trailer) and text2 == false ) then
      TriggerEvent("mt:missiontext", "Attachez votre ~y~remorque~w~.", 15000)
      text2 = true
    end
    Wait(2000)
    ...
    if ( GetDistanceBetweenCoords(currentMission[1], currentMission[2], currentMission[3], trailerCoords ) < 25 and not IsEntityAttached(MISSION.trailer) and MISSION.toDest == false) then
      ...
      TriggerEvent("mt:missiontext", "Retournez votre camion à la ~y~compagnie de transport~w~.", 15000)
      trailerclear(10000)
      MISSION.toDest = true
    elseif ( GetDistanceBetweenCoords(currentMission[1], currentMission[2], currentMission[3], trailerCoords ) < 25 and IsEntityAttached(MISSION.trailer) and MISSION.toDest == false ) then
      TriggerEvent("mt:missiontext", "Vous êtes arrivé. Détachez votre ~y~remorque~w~ avec la touche ~g~H~w~.", 15000)
    end
    ----- BACK TO BASE
    if (IsEntityAttached(MISSION.trailer) and MISSION.toDest == true) then
      TriggerEvent("mt:missiontext", "Détachez votre ~y~remorque~w~ avec la touche ~g~H~w~.", 15000)
    end
...
AddEventHandler("transporter:mission2", function(missionN, trailerN)
  ...
  if DoesEntityExist(truckpos) or DoesEntityExist(trailerpos) then
    TriggerEvent("mt:missiontext", "~r~La place de parking est occupée.", 5000)
  else
    onJobLegal = 1
